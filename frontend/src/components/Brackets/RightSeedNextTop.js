...
function LeftMiddleSeed() {
  ...
  useEffect(() => {
    ...
    if (horizontalLineTopLeft && seedRef && verticalLineTopLeft) {
      ...
      verticalLineTopLeft.style.top = `${horizontalLineTopLeftHeight + 114}px`;
      verticalLineTopLeft.style.left = `-${horizontalLineTopLeftWidth - 28}px`;
...
export default RightSeedNextTop;
